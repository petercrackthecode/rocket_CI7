...
public class GameCanvas extends JPanel {
    ...
    BufferedImage playerImage= loadImage("resources/images/triangle.png");
    ...
    public Player player= new Player(512, 300, playerImage);
    ...
    public void runAll() {
        ...
        this.enemy.runEnemy(player.getXplayer(), player.getYplayer());
    }
    ...
    public void setPlayer(String direction)	{
    	switch(direction)	{
    	case "LEFT": this.player.setXplayer(this.player.getXplayer()-10);
    	break;
    	case "RIGHT": this.player.setXplayer(this.player.getXplayer()+10);
    	break;
    	case "UP": this.player.setYplayer(this.player.getYplayer()-10);
    	break;
    	default: this.player.setYplayer(this.player.getYplayer()+10);
    	break;
    	}
    }
